...
then
	...
	# Llamada recursiva que loguea error en los parametros del log.
	$BINDIR/glog.sh "Glog" "Recibidos $# parametros en lugar de 2 o 3" "ERR"

	# El codigo de error es la cantidad de parametros recibidos.
	exit $#
